      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _data$data$weather$ = data.data.weather[0], description = _data$data$weather$.description, icon = _data$data$weather$.icon; // console.log({ description }, { icon });
...
var signupForm = document.querySelector(".signup-form"); // ANCHOR -- Weather Widget --
