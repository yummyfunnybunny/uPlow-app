...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"weatherApi.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getOpenCageKey = exports.renderWeatherData = exports.getUnit = exports.getWeather = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(_apiRoot, _city, // _country,
  // _state,
  _units, _apiKey) {
    var data, _data$data$main, temp, temp_min, temp_max, _data$data$weather$, description, icon;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get( // `${_apiRoot}?q=${_city},${_country},${_state}&units=${_units}&appid=${_apiKey}`
            "".concat(_apiRoot, "?q=").concat(_city, "&units=").concat(_units, "&appid=").concat(_apiKey));

          case 3:
            data = _context.sent;
            // Destructure data to get stuff you need
            // console.log(data);
            _data$data$main = data.data.main, temp = _data$data$main.temp, temp_min = _data$data$main.temp_min, temp_max = _data$data$main.temp_max; // console.log({ temp }, { temp_min }, { temp_max });

            _data$data$weather$ = data.data.weather[0], description = _data$data$weather$.description, icon = _data$data$weather$.icon;
            console.log({
  ...
  return function getWeather(_x, _x2, _x3, _x4) {
...
var getUnit = function getUnit(_units) {
  console.log(_units);
  return _units === "imperial" ? "F" : "C"; // return _units === "F" ? "imperial" : "metric";
};

exports.getUnit = getUnit;

var renderWeatherData = function renderWeatherData(_weatherData, _units) {
  var description = _weatherData.description,
      icon = _weatherData.icon,
      temp = _weatherData.temp,
      temp_max = _weatherData.temp_max,
      temp_min = _weatherData.temp_min;
  var weatherIcon = document.querySelector(".weather-icon img");
  var weatherDescription = document.querySelector(".weather-description h3");
  var weatherTempMax = document.querySelector(".weather-temp--max .temp-temp");
  var weatherTempCur = document.querySelector(".weather-temp--cur .temp-temp");
  var weatherTempMin = document.querySelector(".weather-temp--min .temp-temp");
  weatherIcon.src = "/img/weather/".concat(icon, ".png");
  weatherDescription.innerText = "".concat(description);
  var unit = getUnit(_units);
  weatherTempMax.innerText = "".concat(Math.round(temp_max), "\xB0 ").concat(unit);
  weatherTempCur.innerText = "".concat(Math.round(temp), "\xB0 ").concat(unit);
  weatherTempMin.innerText = "".concat(Math.round(temp_min), "\xB0 ").concat(unit);
}; // ============================


exports.renderWeatherData = renderWeatherData;
...
function () {
  ...
  return function getOpenCageKey() {
    return _ref2.apply(this, arguments);
  };
}();

exports.getOpenCageKey = getOpenCageKey;
},{"axios":"../../node_modules/axios/index.js"}],"toastNotification.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === "success") {
              console.log("success");
              (0, _toastNotification.showToast)("success", "logged in successfully!");
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === "successfully logged out") {
              ...
              (0, _toastNotification.showToast)("success", "Logout Successful!");
              setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _toastNotification.showToast)("error", "Error logging out! Try again...");
...
},{"axios":"../../node_modules/axios/index.js","./toastNotification":"toastNotification.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm, role) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === "success") {
              console.log("success");
              (0, _toastNotification.showToast)("success", "signed up successfully!");
              window.setTimeout(function () {
                location.assign("/dashboard");
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _toastNotification.showToast)("error", "you suck at signing up!");
...
},{"axios":"../../node_modules/axios/index.js","./toastNotification":"toastNotification.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _toastNotification.showToast)("success", "".concat(type.toUpperCase(), " updated successfully!")); // refresh the window aftert 1 second once the data was updated successfully
...
},{"axios":"../../node_modules/axios/index.js","./toastNotification":"toastNotification.js"}],"carousel.js":[function(require,module,exports) {
"use strict";
...
var carouselController = function carouselController() {
  ...
  var slideIndicators = document.querySelectorAll(".controls ul li"); // ANCHOR -- Initialize direction --

  var direction = -1;
  var sliderIndex = 0;
  var sliderLength = document.querySelectorAll(".slider section").length; // ANCHOR -- Event Listeners --

  prev.addEventListener("click", scrollLeft);
  next.addEventListener("click", scrollRight);
  slider.addEventListener("transitionend", transitionEnd); // ANCHOR -- Functions --
  ...
  var updateSliderIndex = function updateSliderIndex(direction) {
    ...
    slideIndicators.forEach(function (e) {
...
var displayMap = function displayMap(locations) {
  console.log("MAPBOX LOCATIONS:"); // 1) Save Access Token

  mapboxgl.accessToken = "pk.eyJ1IjoieXVtbXlmdW5ueWJ1bm55IiwiYSI6ImNrODZwNzQydDA1bjEzZW15NTRqa2NpdnEifQ.6y8NFU2qjw6mTgINZYaRyg"; // 2) Create MapBox Map
  ...
  var map = new mapboxgl.Map({
    ...
    zoom: 15 // interactive: false,

  }); // 3 Create Bounds

  var bounds = new mapboxgl.LngLatBounds(); // 4) Add Location Markers
  ...
  locations.forEach(function (location) {
    ...
    marker.addEventListener("click", function () {
      ...
      var ownerPic = document.querySelector(".owner-info .prof-pic img");
      var ownerName = document.querySelector(".owner-info span");
      var instructions = document.querySelector(".notes ul");
      var imageLinks = document.querySelectorAll(".image-gallery a");
      ...
      ownerPic.src = "/img/users/".concat(location.owner[0].photo);
      ownerName.innerText = "".concat(location.owner[0].name); // const ratingsAvg = document.querySelector('.meta-info div');
      ...
      imageLinks.forEach(function (link, idx) {
        link.href = "/img/locations/driveway".concat(idx + 1, ".jpg");
      });
...
// Element Selectors
var weatherWidget = document.querySelector(".hero-weather");
var loginForm = document.querySelector("#loginForm");
var signupForm = document.querySelector(".signup-form");
var logoutBtn = document.querySelector("#logoutBtn");
var profileInfoForm = document.getElementById("profileInfo");
var carousel = document.querySelector(".hero-carousel");
var yourJobs = document.querySelector(".dashboard-jobs");
var mapbox = document.querySelector(".map");
var toggleExpand = document.querySelector(".toggle-expand");

if (carousel) {
  (0, _carousel.carouselController)();
}

function getLocalInfo(_x) {
  return _getLocalInfo.apply(this, arguments);
...
function _getLocalInfo() {
  _getLocalInfo = _asyncToGenerator(
  /*#__PURE__*/
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    var email = document.querySelector("#emailInput").value;
    var password = document.querySelector("#passwordInput").value;
    var passwordConfirm = document.querySelector("#passwordConfirmInput").value;
...
if (toggleExpand) {
  toggleExpand.addEventListener("click", function () {
    ...
    for (var i = 0; i < elements.length - 1; i++) {
      if (elements[i].classList.contains("image-gallery") || elements[i].classList.contains("notes") || elements[i].classList.contains("actions")) {
