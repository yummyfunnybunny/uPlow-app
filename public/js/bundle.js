...
exports.renderWeatherData = exports.getUnit = exports.getWeather = void 0;
...
} else {} // ANCHOR -- Weather Widget --


if (weatherWidget) {
  // Set Weather Variables
  var apiRoot = "https://api.openweathermap.org/data/2.5/weather";
  var city = "Contoocook";
  var units = "imperial";
  var apiKey = ""; // Load default weather info on window load
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _weatherApi.getWeather)(apiRoot, city, units, apiKey);

            case 2:
              weatherData = _context.sent;
              // 2) render Weather Data
              (0, _weatherApi.renderWeatherData)(weatherData, units);
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee2(e) {
      var unitInput, cityInput, weatherData;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault(); // 1) Get user input info

              unitInput = document.querySelector(".unit-input").value === "F" ? "imperial" : "metric"; // 2) retreive weatherData from getWeather function

              cityInput = document.querySelector(".city-input").value;
              _context2.next = 5;
              return (0, _weatherApi.getWeather)(apiRoot, cityInput, unitInput, apiKey);

            case 5:
              weatherData = _context2.sent;
              // 2) render Weather Data
              (0, _weatherApi.renderWeatherData)(weatherData, unitInput);
